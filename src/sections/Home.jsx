import herobanner from "../assets/sobhahos.png"; // Importing hero banner background image
...
export const Home = ({ openContactModal }) => {
  ...
  const overlayStyle = {
    backgroundImage: isMobile
      ? "linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.2), rgba(0,0,0,0.3) )"
